...
test.describe('Tasks CRUD API - Happy paths', () => {
  ...
  test('Debe listar tareas correctamente', async ({ request }) => {
    const taskClient = new TaskClient(request);
  ...
  test('Debe crear una tarea correctamente', async ({ request }) => {
    const taskClient = new TaskClient(request);
  ...
  test('Debe consultar una tarea existente por ID', async ({ request }) => {
    const taskClient = new TaskClient(request);
  ...
  test('Debe actualizar una tarea completa correctamente', async ({ request }) => {
    const taskClient = new TaskClient(request);
  ...
  test('Debe actualizar solo el estado de una tarea correctamente', async ({ request }) => {
    const taskClient = new TaskClient(request);
  ...
  test('Debe eliminar una tarea existente correctamente', async ({ request }) => {
    const taskClient = new TaskClient(request);
  ...
  test('Debe ejecutar correctamente el flujo CRUD completo de tareas', async ({ request }) => {
    const taskClient = new TaskClient(request);
